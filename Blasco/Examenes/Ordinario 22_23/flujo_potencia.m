...
disp('Tensiones en los nudos, u:')
u
disp('Ángulos de potencia, d:')
d
disp('Potencia en los nudos, p:')
p
disp('Potencia reactiva en los nudos, q:')
q
disp('Flujos de potencia:')
sab
disp('Pérdidas en las líneas: ')
perd