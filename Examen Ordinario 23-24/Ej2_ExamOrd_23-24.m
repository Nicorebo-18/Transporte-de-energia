...
display(['Corriente de pico por fase de linea 13 = ',num2str(i13*Ib*2*sqrt(2)/1e3),' kA'])
display(['Corriente de pico por fase de linea 23 = ',num2str(i23*Ib*2*sqrt(2)/1e3),' kA'])
display(['Corriente de pico por fase de linea 34 = ',num2str(i34*Ib*2*sqrt(2)/1e3),' kA'])
...
e3 = [0; upf; 0];        % f.e.m del generador 3
ifaltag3=(e3-ufalta(:,5)).*yg3;
IFaltag3=abs(A*ifaltag3);        % Módulo de las corrientes por fase en p.u.

display(['Corriente de pico por fase del generador 3 = ',num2str(IFaltag3(1)*Ib5*2*sqrt(2)/1e3),' kA'])


% Por si no se ejecuta, salida de octave:

% Resultados:
% Corriente de pico por fase de linea 13 = 4.7153 kA
% Corriente de pico por fase de linea 23 = 2.478 kA
% Corriente de pico por fase de linea 34 = 2.1746 kA
% Corriente de pico por fase del generador 3 = 406.9316 kA